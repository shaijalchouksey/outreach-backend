...
// --- YEH HAI FIX ---
// Actor ID "clockworks/tiktok-scraper" nahi, "clockworks~tiktok-scraper" hona chahiye
const TIKTOK_ACTOR_ID = "clockworks~tiktok-scraper"; // (Ghalat / ko sahi ~ se badal diya)
...
                        item.commentCount || 0,
                        item.shareCount || 0,
            D             JSON.stringify(item) // Poora data JSONB column mein daalo
                    ];
                    
